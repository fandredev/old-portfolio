...
enum Techs {
  Docker = "Docker",
  FastAPI = "FastAPI",
  Angular = "Angular 9 & Angular Material",
  ReactTech = "React",
  HTML5 = "HTML5",
  CSS3 = "CSS3",
  Sass = "Sass",
...
export enum DescTechs {
  ...
  SASSDesc = "O dinamismo que o SASS traz faz com que eu o utilize em alguns dos meus projetos pessoais.",
  TypescriptDesc = "Sinceramente não consigo mais viver sem Typescript. A tipagem e a facilidade de debugar é algo incrível. Desde que conheci a tipagem do TS, não consigo mais viver sem e é sem dúvidas o que mais uso no dia a dia no front-end (Com Angular/React).",
  ...
  ReactDesc = "Meu framework favorito e sempre estou de olho nele, sempre fazendo projetinhos com ele, sempre me atualizando. Recentemente comecei a usar ele com o vite invés de CRA para criar projetos web.",
