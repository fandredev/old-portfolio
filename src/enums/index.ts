...
export enum DescTechs {
  ...
  NextJSDesc = "Utilizei muito ano passado (2023) e esse ano também e as vezes até utilizo em algum freela projeto pessoal ou outro. Gosto muito da ferramenta e da facilidade de criar um projeto/web pages com ele.",
